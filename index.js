...
function addGamesToPage(games) {
    let parent = document.querySelector("#games-container");
...
let numUnfunded = listUnfundedGames.length;

// create a string that explains the number of unfunded games using the ternary operator
let explanationStr = `A total of $${totalPledged.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfunded} ${(numUnfunded > 1) ? "games remain" : "game remains"} unfunded. We need your help to fund these amazing games!`;


// create a new DOM element containing the template string and append it to the description container
const newParagraph = document.createElement("p");
newParagraph.innerHTML = explanationStr;
...
newPara1.innerHTML = mostFunded.name;
firstGameContainer.appendChild(newPara1);

// do the same for the runner up item
const newPara2 = document.createElement("p");
newPara2.innerHTML = secondMostFunded.name;
